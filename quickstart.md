...
Use packet.net to create bare metal server. I used c2.medium.x86 in Amsterdam region to create bare metal server with Centos7 as OS.
...
```
wget https://raw.githubusercontent.com/srinivma1/openshift4.1-baremetal-upi/master/virt-net.xml
```
...
```
wget https://raw.githubusercontent.com/srinivma1/openshift4.1-baremetal-upi/master/helper-ks.cfg
```
...
git clone https://github.com/srinivma1/openshift4.1-baremetal-upi
cd openshift4.1-baremetal-upi
```
